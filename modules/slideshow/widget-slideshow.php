...
class TRS_Widget_Slideshow extends \Elementor\Widget_Base {
	...
	private function render_nav_lines( int $total ): void {
		...
		for ( $i = 0; $i < $total; $i++ ) {
			printf(
				'<button type="button" class="trs-ss-line%1$s" data-idx="%2$d" role="tab" aria-selected="%3$s" aria-label="%4$s"><span class="trs-ss-line-fill"><span class="trs-ss-line-progress"></span></span></button>',
